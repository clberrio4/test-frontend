        ...
        <div className="bg-gray-100 flex items-center justify-center px-2">
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8">
                {clients!.map((user) => (
                    <div
                        key={user.id}
                        className="bg-white shadow-xl rounded-2xl p-6 flex flex-col items-center text-center transition transform hover:scale-105 hover:shadow-2xl"
                    >
                        <img
                            src={user.avatarUrl}
                            alt={user.name}
                        ...
                        <div className="flex gap-3 mt-4">
                            <button
                                title="Editar"
                                className="bg-yellow-600 hover:bg-yellow-700 text-white rounded-md p-2 shadow-lg transition"
                            ...
                            <button
                                title="Ver más"
                                className="bg-blue-600 hover:bg-blue-700  text-white rounded-md p-2 shadow-lg transition"
